...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            email_template = loader.get_template('password_reset/password_reset_email.html')
            ...
            # Testa template HTML se existir
            try:
                ...
                self.stdout.write(f"Erro ao carregar template HTML: {e}")
