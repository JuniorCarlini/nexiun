...
SYSTEM_MODULES = {
    ...
    'projetos': {
        ...
        'permissions': [
            ...
            ('change_project_release', 'Liberar projetos (fase Liberado)'),
            ('change_project_finalize', 'Finalizar projetos (última fase)'),
            ('change_project_to_revenue', 'Mover projeto para fase Receita (RC)'),
            ('complete_project', 'Concluir projeto definitivamente'),
        ]
    },
    'financeiro': {
        'name': 'Financeiro',
    ...
    'unidades': {
        ...
        'permissions': [
            ...
            ('view_all_units', 'Ver todas as unidades da empresa'),
            ('view_unit_financial_dashboard', 'Ver dashboard financeiro da unidade'),
            ('add_bank_accounts', 'Adicionar contas bancárias'),
            ('change_bank_accounts', 'Editar contas bancárias'),
            ('delete_bank_accounts', 'Excluir contas bancárias'),
        ]
    },
    'relatorios': {
        'name': 'Relatórios',
...
DEFAULT_ROLES = {
    'ceo': {
        ...
        'permissions': [
            ...
            'users.change_project_payments', 'users.change_project_release', 'users.change_project_finalize', 
            'users.change_project_to_revenue', 'users.complete_project',
            ...
            'users.view_all_units',             'users.view_unit_transactions', 'users.add_unit_transactions', 'users.change_unit_transactions', 
            'users.delete_unit_transactions', 'users.view_all_unit_transactions', 'users.view_unit_financial_dashboard',
            'users.add_bank_accounts', 'users.change_bank_accounts', 'users.delete_bank_accounts',
    ...
    'diretor': {
        ...
        'permissions': [
            ...
            'users.view_units', 'users.view_all_units', 'users.change_units', 'users.manage_units_master',
    ...
    'gerente': {
        ...
        'permissions': [
            ...
            'users.change_project_release', 'users.change_project_to_revenue',
    ...
    'franqueado': {
        ...
        'permissions': [
            ...
            'users.view_reports',
            'users.view_unit_transactions', 'users.add_unit_transactions', 'users.change_unit_transactions', 'users.view_unit_financial_dashboard',
            'users.add_bank_accounts', 'users.change_bank_accounts',
            'users.view_dashboard', 'users.view_unit_dashboard',
            'users.view_messages', 'users.add_unit_messages', 'users.change_messages', 'users.view_unit_messages',
        ]
    },
    'financeiro': {
        ...
        'permissions': [
            ...
            'users.change_project_payments', 'users.complete_project',
            'users.view_financial', 'users.add_financial', 'users.change_financial',
            'users.view_reports_financial', 'users.export_reports_financial',
            'users.view_clients', 'users.view_all_clients',
            'users.view_reports', 'users.export_reports',
            'users.view_dashboard',
            'users.view_messages', 'users.add_messages', 'users.change_messages',
            'users.view_all_messages', 'users.add_company_messages',
            # Adicionar permissões para acessar todas as unidades e transações financeiras
            'users.view_all_units', 'users.view_unit_transactions', 'users.add_unit_transactions', 
            'users.change_unit_transactions', 'users.delete_unit_transactions', 
            'users.view_all_unit_transactions', 'users.view_unit_financial_dashboard',
            'users.add_bank_accounts', 'users.change_bank_accounts', 'users.delete_bank_accounts',
